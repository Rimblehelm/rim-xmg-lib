...
[rim-xmg-lib](../../modules.md) / [src](../README.md) / XMGScriptPublicKey

# Class: XMGScriptPublicKey

Defined in: src/XMGScriptPublicKey.ts:22
...
Defined in: src/XMGScriptPublicKey.ts:35
...
Defined in: src/XMGScriptPublicKey.ts:27
...
Defined in: src/XMGScriptPublicKey.ts:23
...
Defined in: src/XMGScriptPublicKey.ts:24
...
Defined in: src/XMGScriptPublicKey.ts:25
...
Defined in: src/XMGScriptPublicKey.ts:26
...
Defined in: src/XMGScriptPublicKey.ts:66
...
Defined in: src/XMGScriptPublicKey.ts:56
...
Defined in: src/XMGScriptPublicKey.ts:48
